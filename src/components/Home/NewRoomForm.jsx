...
var About = React.createClass({
    ...
    render: function(){
        return (<form onSubmit={this.makeRoom}>
            ...
            <input type="radio" name="passwordProtected" value="false" checked="checked"/> No
            <label>When should this room be deleted?</label>
            <select name="duration" id="durationSelector">
                <option value="day" selected="selected">Tomorrow</option>
    ...
    makeRoom: function(e){
        ...
        let that = this;
        axios.post("/makeRoom", {roomName: that.state.roomName.trim().substr(0, 150), passwordProtected: radios[0].checked, 
